...
- setup values for - MONGO_URL, JWT_SECRET, JWT_LIFETIME,PANGEA_EMBARGO_TOKEN,PANGEA_DOMAIN

- Set up environment variables (Instructions) PANGEA_EMBARGO_TOKEN and PANGEA_DOMAIN with your project token configured on Pangea User Console (token should have access to Embargo service Instructions) and with your pangea domain.
